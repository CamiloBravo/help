...
class ReportDriverBloc extends BlocBase {
  ...
  calcularTotal(List<Relatorio> relatorios, List<Emergencias> viagens) async {
    double totalViagens = 0;
    double totalGastos = 0;

    if (viagens != null)
      viagens.forEach((Emergencias e) {
        totalViagens +=
  ...
  calcularTotalFiltro(List<Relatorio> relatorios, List<Emergencias> viagens) async {
    double totalViagens = 0;
    double totalGastos = 0;
