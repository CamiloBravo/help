...
class Police extends StatefulWidget{
  @override
  _Police createState() => new _Police();
}
          ...
          child: new Column(
            children: <Widget>[
              new CheckboxListTile(
                ...
                title: new Text('Trafico de drogas'),
                //controlAffinity: ListTileControlAffinity.leading,
                secondary: new Icon(Icons.backspace),
                activeColor: Colors.green,
              ),
              new CheckboxListTile(
                value: _value2,
                onChanged: _value2Changed,
                title: new Text('Robo de vehículo'),
                //controlAffinity: ListTileControlAffinity.leading,
              ...
              new CheckboxListTile(
                ...
                title: new Text('Riña o Pelea'),
                //controlAffinity: ListTileControlAffinity.leading,

                secondary: new Icon(Icons.zoom_in),
                activeColor: Colors.green,
              ),
              new CheckboxListTile(
                value: _value4,
                onChanged: _value4Changed,
                title: new Text('Persona Herida'),
                //controlAffinity: ListTileControlAffinity.leading,
              ...
              new CheckboxListTile(
                ...
                title: new Text('Persona sin vida'),
                //controlAffinity: ListTileControlAffinity.leading,

                secondary: new Icon(Icons.add_location),
                activeColor: Colors.green,
              ),
              new CheckboxListTile(
                value: _value6,
                onChanged: _value6Changed,
                title: new Text('Vecinos ruidosos'),
                //controlAffinity: ListTileControlAffinity.leading,

                secondary: new Icon(Icons.queue_music),
                activeColor: Colors.green,
              ),
              new CheckboxListTile(
                value: _value7,
                onChanged: _value7Changed,
                title: new Text('Atraco'),
                //controlAffinity: ListTileControlAffinity.leading,
              ...
              new CheckboxListTile(
                ...
                secondary: new Icon(Icons.looks),
                activeColor: Colors.green,
              ),
          RaisedButton(
