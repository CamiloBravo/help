...
class DriverFoundWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<Emergencias> snapshot) {
          if (!snapshot.hasData)
            return Container(
              height: 1,
              width: 1,
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(
                            'Tu emergencia será atentida en breve por nuestras autoridades. No te muevas del lugar',
