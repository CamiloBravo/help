...
class _HistoricPageState extends State<HistoricPage> {
  Future<List<Emergencias>> listaViagens;
          ...
          children: <Widget>[
            Container(
              child: StreamBuilder(
                  ...
                  builder:
                      (BuildContext context, AsyncSnapshot<List<Emergencias>> snapshot) {
                    if (!snapshot.hasData ||
                    ...
                    List<Emergencias> listaViagens = snapshot.data;

                    if (listaViagens.length == 0)
                      return Center(
                          child: Container(
                        child: Text(
                          'No hay registro de emergencias',
                          style:
  ...
  _verificaCustoViagem(Emergencias viagem) {
    if (viagem.Status != TravelStatus.Finished) return "Cancelado";
...
//        : 'R\$${(viagem.ValorTop).toStringAsFixed(2)} ';
  ...
  _itemHistorico(Emergencias viagem) => new Container(
        child: new Container(
